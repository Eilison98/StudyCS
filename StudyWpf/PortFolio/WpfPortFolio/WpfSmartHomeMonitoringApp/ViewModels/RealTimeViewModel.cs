...
namespace WpfSmartHomeMonitoringApp.ViewModels
{
    class RealTimeViewModel : Screen
    {
        ...
        public RealTimeViewModel()
        {
            ...
            Commons.PUB_TOPIC = "home/device/#";  //  MQTT Program Topic 문자가 틀리면 데이터가 안들어옴  // #은 모든데이더가 다 들어옴

            LivingTempVal = DinningTempVal = BedTempVal = BathTempVal = string.Empty;  //  string
            LivingHumidVal = DinningHumidVal = BedHumidVal = BathHumidVal = 0;         //  double
